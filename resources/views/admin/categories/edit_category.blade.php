      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{!! url('/admin/edit-category/'.$category->id); !!}" name="edit_category" id="edit_category" novalidate="novalidate">{{ csrf_field() }}
